...
interface ServicesMockupProps {
  mockup: string
  index: number
}

export default function ServicesMockup({ mockup, index }: ServicesMockupProps) {
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 p-4">
        ...
        >
          <div className="bg-gray-800 rounded-lg p-3 h-full">
            ...
            <div className="space-y-1">
              {["Ключевые слова", "Backlinks", "DA Score"].map((item, i) => (
      ...
      {mockup === "analytics" && (
        ...
        >
          <div className="bg-gray-800 rounded-lg p-3 h-full">
            <div className="text-xs text-gray-400 mb-3">Аналитика</div>
            <div className="flex items-end space-x-1 mb-3 h-16">
